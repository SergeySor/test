...
class FileInfoView extends StatelessWidget {
  FileInfoView({Key? key, required this.file}) : super(key: key);
  final FileInfo file;
  ...
  Widget build(BuildContext context) {
    return ModalBottomView(
      ...
      children: [
        ...
        _infoRow(context, translate.file_creation_date, file.date),
        _infoRow(context, translate.file_modify_date, file.date),
        _infoRow(context, translate.file_last_opened_time, file.date),
        _infoRow(context, translate.file_location, file.date),
        _wrapWithPadding(
          child: Row(
            children: [
              GestureDetector(
