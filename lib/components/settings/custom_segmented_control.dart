...
const Radius _kThumbRadius = Radius.circular(101);
...
const Radius _kSeparatorRadius = Radius.circular(101); //_kSeparatorWidth / 2);
...
const double _kCornerRadius = 101;
...
class _SegmentedControlState<T>
    extends State<CustomCupertinoSlidingSegmentedControl<T>>
